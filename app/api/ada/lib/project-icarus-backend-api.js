...
export const getUTXOsForAddresses = (addresses: Array<string>) =>
  ...
  .catch((error) => {
    Logger.error('project-icarus-backend-api::getUTXOsForAddresses error: ' + stringifyError(error));
...
export const getUTXOsSumsForAddresses = (addresses: Array<string>) =>
  ...
  .catch((error) => {
    Logger.error('project-icarus-backend-api::getUTXOsSumsForAddresses error: ' + stringifyError(error));
...
export const getTransactionsHistoryForAddresses = (addresses: Array<string>,
  ...
  .catch((error) => {
    Logger.error('project-icarus-backend-api::getTransactionsHistoryForAddresses error: ' + stringifyError(error));
...
export const sendTx = (signedTx: string) =>
  ...
  .catch((error) => {
    Logger.error('project-icarus-backend-api::sendTx error: ' + stringifyError(error));
...
export const checkAddressesInUse = (addresses: Array<string>) =>
  ...
  .catch((error) => {
    Logger.error('project-icarus-backend-api::checkAddressesInUse error: ' + stringifyError(error));
...
export const getPendingTxsForAddresses = (addresses: Array<string>) =>
  ...
  .catch((error) => {
    Logger.error('project-icarus-backend-api::getPendingTxsForAddresses error: ' + stringifyError(error));
